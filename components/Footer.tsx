...
export default function Footer() {
  ...
  return (
    <footer style={{
      background: 'linear-gradient(180deg, var(--verde-600) 0%, var(--verde-700) 100%)',
      color: 'white',
      ...
      <div className="wrapper">
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 2 }} className="footer-cta-btn">
            <Link href="/associe-se" className="botao botao-branco" style={{ color: 'var(--laranja-500)' }}>
              Associe-se Agora
        ...
        <div style={{
          ...
          <div style={{ maxWidth: '350px' }}>
            <Link href="/" aria-label="SINMEVACO" style={{ display: 'inline-block', marginBottom: 'var(--space-lg)' }}>
              <Image
            ...
            <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: 1.8, marginBottom: 'var(--space-lg)' }}>
            ...
            <div style={{ display: 'flex', gap: 'var(--space-sm)' }}>
              <a
                ...
                onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--laranja-500)'; e.currentTarget.style.transform = 'translateY(-3px)'; }}
          ...
          <div>
            <h4 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 'var(--space-lg)', color: 'white' }}>
              Links Rápidos
            </h4>
              ...
              {beneficios.map((item, index) => (
                <li key={index} style={{ marginBottom: '0.75rem' }}>
                  <Link
                    ...
                    onMouseEnter={(e) => { e.currentTarget.style.color = 'var(--laranja-400)'; }}
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
              ...
              <a
                href="mailto:contato@sinmevaco.com.br"
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '0.75rem',
              ...
              <div style={{
                ...
                <span>Ipatinga, Timóteo, Coronel Fabriciano - MG</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.8125rem', margin: 0 }}>
              Desenvolvido por <strong style={{ color: 'rgba(255,255,255,0.7)' }}>Galaxy IT & Marketing</strong>
            </p>
          </div>
        </div>
      </div>
